...
class User():
    ...
    def createchat(self, chatname, user):
        ...
        self.chat.send_message(
            "O Usuario," + self.username + ',convidou você , (' + user + ') para um chat privado, ->' + chatname + '<- Click aqui para ir.',
            self.my_uri)
    ...
    def incoming_message(self, message):
        ...
        if len(msgsplit) > 1:
            ...
            elif str(msgsplit[1]) == ' desconectou-se do grupo.':
    ...
    def enviar_arquivo(self):
        ...
        self.chat.send_message("O Usuario," + self.username + ',Enviou o arquivo, ->' + os.path.basename(
            file) + '<- Click aqui para baixar.', self.my_uri)
